...
export default function CommunityResults({ selectedSessionKey }) {
    ...
    if (isAdmin) {
        if (!replay.minimumVoterCountReached) {
            return (
                <>
                    ...
                    <p className="results__footnote">
                        ...
                        {replay.voterCount > 1 ? 's' : ''} pris en compte pour
                        cette session.
                    </p>
                </>
            );
        ...
        if (false && !replay.minimumVoterCountReached) {
            return (
                <>
                    <section className="results__messagePanel">
